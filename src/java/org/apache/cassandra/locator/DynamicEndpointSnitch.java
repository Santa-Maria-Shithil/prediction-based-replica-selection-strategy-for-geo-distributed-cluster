...
public class DynamicEndpointSnitch extends AbstractEndpointSnitch implements LatencySubscribers.Subscriber, DynamicEndpointSnitchMBean
{
    ...
    private volatile static HashMap<InetAddressAndPort, Double> scores = new HashMap<>();
    ...
    public static void updateScores(double lema, double qema, double sema, InetAddressAndPort key) // this is expensive
    {
...
//c3 end
    ...
    private static double getSeverity(InetAddressAndPort endpoint)
    {
